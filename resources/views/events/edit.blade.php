				...
				<ul>
					...
					<li>
						<a href="add-listing.html" class="ttr-material-button">
		                	...
		                	<span class="ttr-label">Edit Listing</span>
		                </a>
		            </li>
					<li>
						<a href="#" class="ttr-material-button">
				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						...
						<div class="widget-inner">
							<form class="edit-profile m-b30" action="{{ route('events.update',$event->id) }}" method="POST" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="form-group col-6">
										...
										<div>
											<input class="form-control" value="{{ $event->ev_name }}" name="ev_name" type="text" value="">
                                            @error('ev_name')
									...
									<div class="form-group col-6">
										...
										<div>
											<input class="form-control" name="ev_date"  type="date" value="{{ $event->ev_date }}">
												...
												<td>
													<div class="row">
														<div class="col-md-4">
															...
															<div>
																<input class="" type="file" name="image" id="inputImage">
                                                                @error('image')
                                                                <small class="text-danger"><{{ $message }}></small>
                                                                @enderror
									...
									<div class="col-12">
										<button type="submit" class="btn-secondry"><i class="fa fa-fw fa-plus-circle"></i>Edit </button>
