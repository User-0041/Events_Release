...
<div id="loading-icon-bx"></div>
    ...
    <div class="page-content bg-white">
        <!-- inner page banner -->
        <div class="page-banner ovbl-dark" style="background-image:url(PreReq/images/banner/banner3.jpg);">
            <div class="container">
            ...
            <div class="container">
                <div class="row">
					...
					<div class="col-lg-7 col-md-7">
						<form  action="{{route('send-email')}}" method="POST" enctype="multipart/form-data" class="contact-bx " >
                            @csrf
							...
							<div class="row placeani">
								<div class="col-lg-6">
										...
										<div class="input-group">
											...
											<input name="name" name type="text" required class="form-control valid-character">
										</div>
